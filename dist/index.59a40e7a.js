...
(0, _jqueryDefault.default)("#input_pokemon").on("keydown", (e)=>{
    if (e.keyCode === 13) {
        e.preventDefault();
        return false;
    }
...
(0, _jqueryDefault.default)("#buscar_pokemon").on("click", ()=>{
...
function llenarInfo(name, sprites, stats, types) {
    ...
    for(let i = 0; i < types.length; i++)tablaTipo += `<td class="negrita">${types[i].type.name}</td>`;
    tablaTipo += "</tr> </table>";
...
},{"jquery":"hgMhh","./api":"9u7qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{"./url":"g3VGB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g3VGB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["6fRhY","8lRBv"], "8lRBv", "parcelRequireb9fc")
